    ...
    osmium::unsigned_object_id_type cop )
{
  ...
  //std::cout << "COP SENT TO GANG WITH A TOTAL DISTANCE OF " << dst(cop, gangsters[0].to)<<std::endl;
  //std::cout << "Closer would have been: "<< dst(cop, gangsters[gangsters.size()].to)<<std::endl;
